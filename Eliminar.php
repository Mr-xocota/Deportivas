            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    <li class="right"><a href="generarReporte.html">Reportes</a></li>
                       ...
                       <li><a href="Modificar.php">Actualizar Datos</a></li>
...
print("<div  class='form'>");  
 ...
 printf("<form  id='contactform' method='POST' action='seleccionar.php'>");
  //LABEL PARA LA ETIQUETA  
      print ("<h1>Dar de baja a alumno</h1>");
...
printf("<input type='text'   name='name' placeholder='Número de control' style='text-transform:uppercase' value='".$fila['Ncontrol']."'>");
      ...
      //BOTON PARA BUSCAR DATOS 
	          printf("<input class='buttom' name='buscarElim'  value='Buscar' type='submit'>");
...
echo"<br>";
     ...
     echo"<br>";
      ...
      printf(" <p class='contact'><label>Actividad</label></p>");
       printf("<input name='actividad' placeholder='Apellido materno' type='text' value='".$fila['Actividad']."'>");
      echo"<br>";
         
      //BOTON PARA ACTUALIZAR DATOS EN EL CAMPO SALDO 
        printf("<input class='buttom-right' name='eliminar'  value='Eliminar' type='submit'>");
    printf ("</form>");
